...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${BASE_URL}/blog/ai-automation-data-security`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/ai-automation-cost-roi`,
      lastModified: new Date("2026-05-30"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/will-ai-automation-replace-employees`,
      lastModified: new Date("2026-05-28"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/n8n-vs-zapier-vs-make`,
      lastModified: new Date("2026-05-26"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/small-business-marketing-budget`,
      lastModified: new Date("2026-05-31"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/how-to-choose-digital-marketing-agency`,
      lastModified: new Date("2026-05-24"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/do-i-need-a-website-google-business-profile`,
      lastModified: new Date("2026-05-27"),
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/blog/custom-website-vs-wordpress`,
